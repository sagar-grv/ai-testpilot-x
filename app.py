...
c1.metric(
    "AI Agents",
    "9",
    help="RequirementAgent · TestCaseAgent · VerificationAgent · SeleniumAgent · APIAgent · ExecutionAgent · BugAgent · HealingAgent · ReportAgent",
)
c2.metric(
    "Execution Mode",
    cfg.EXECUTION_MODE,
    help="MOCK = simulated results · LOCAL = real Chrome · GRID = Selenium Grid",
)
c3.metric(
    "LLM",
    "Gemini 2.5 Flash",
    help="Google Gemini 2.5 Flash via google-generativeai SDK",
)
c4.metric(
    "Vector DB",
    "ChromaDB",
    help="sentence-transformers all-MiniLM-L6-v2 · 4 collections",
)
