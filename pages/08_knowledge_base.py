...
# Stats
st.markdown('<div class="tp-section-title">Index Statistics</div>', unsafe_allow_html=True)
...
# ── Search ────────────────────────────────────────────────────────────────────
st.markdown('<div class="tp-section-title">Semantic Search</div>', unsafe_allow_html=True)
...
if query:
    ...
    if results:
        ...
        for r in results:
            ...
            sim_color = "#22c55e" if sim > 0.7 else "#f59e0b" if sim > 0.4 else "#64748B"
...
# ── Ingestion ─────────────────────────────────────────────────────────────────
st.markdown('<div class="tp-section-title">Ingest Documents</div>', unsafe_allow_html=True)
